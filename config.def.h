...
static char  dmenufont[]            = "DroidSansMonoNerdFont:size=10:weight=80";
...
const char *spcmd2[] = {"urxvt", "-fn","xft:DroidSansMonoNerdFontMono:size10","-name","spfm","-g","120x34","-e","ranger", NULL};
...
/* class     instance  title           tags mask  isfloating  isterminal  noswallow  monitor */
	...
	{ "Blender", NULL,     NULL,           0,         0,          1,           0,        -1 },
	{ NULL,      NULL,     "Event Tester", 0,         0,          0,           1,        -1 }, /* xev */
	{ NULL,      "spterm",    NULL,        SPTAG(0),  1,          1,           0,        -1 },
	{ NULL,      "spfm",      NULL,        SPTAG(1),  1,          1,           0,        -1 },
	{ NULL,      "sppython",  NULL,        SPTAG(2),  1,          1,           0,        -1 },
};
